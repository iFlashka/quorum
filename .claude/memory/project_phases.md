...
- 2026-05-06: **Фаза 0 завершена и принята.** Tauri-окно открывается, three-column shell в стиле Discord, frameless titlebar работает, палитра выверена по актуальному Discord 2026 (см. PROJECT.md), Inter Variable со включёнными character variants, инфра docker-compose готова, ADR 0001/0002/0003 задокументированы, тесты + lint + typecheck зелёные. Готовы переходить к фазе 1 после явного согласия пользователя.
